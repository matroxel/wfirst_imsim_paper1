...
\verify{Heyang: Do we need to describe the details of the gaussian random field generation process in appendix?}
...
Here we generate a random time-dependent function $f(t)$ following a power spectrum to quantify  the perturbation of Zernike terms. The form of power spectrum is $P(\nu)=\frac{A}{1+(\nu/\nu_0)^2}$, with $A=\frac{\sigma^2}{\pi\nu_0}$, $\sigma=6nm$, $\nu_0=\frac{1}{2\pi\tau}=3.14\times10^{-4}Hz$ as the time constant $\tau=1hr$. 
...
\hline\hline
Band $\alpha$ & $\ell_{\rm min}(\alpha)$ & $\ell_{\rm max}(\alpha)$ & Allocation $Z(\alpha)$ & $A_0^{\rm flat}(\alpha)$ & $S_{\rm max,\pm}(\alpha)$ & $S_{\rm max,+}(\alpha)$ \\ \hline
