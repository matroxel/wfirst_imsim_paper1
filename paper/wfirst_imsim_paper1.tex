...
P(\nu)=\frac{A}{1+(\nu/\nu_0)^2},
\end{equation}
with normalization factor $A$. The rms variance of of $f(t)$ ($\sigma^2$) can be expressed as
\begin{equation}
...
\caption{Table} Ellipticities changes with respect to Zernike coefficients for different modes. The units of high-frequency modes, i.e. IsoJitter, AniJitter and Ranjitter are ${\rm milliarcsec}^{-2}$. For all other modes the units are ${\rm nm}^{-1}$.
\begin{center}
...
Astig                 & $-4.5\times 10^{-4} \pm 3.1\times 10^{-6}$ & $-1.0\times 10^{-5} \pm 3.0\times 10^{-6}$  \\
Coma                & $-1.0\times 10^{-4} \pm 3.2\times 10^{-6}$ & $3.0\times 10^{-6} \pm 3.2\times 10^{-6}$  \\
