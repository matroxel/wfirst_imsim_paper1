...
We use a blending-free version of this simulation to test the impact on weak lensing science of a variety of simulated wave-front modeling errors, including static, low-, and high-frequency biases. 
...
\end{center}
\caption[]{
The number of simulated exposures per object (blue) compared to the number eventually used in the shape measurement (orange). The median number of exposures per object both simulated and used is 6 over this part of the five-year simulated High-Latitude Survey.
\label{fig:hist2}}
\end{figure}
