...
\begin{table}
\caption{Table}{Additive and multiplicative bias parameter changes in each version of the simulation relative to the \textsc{Fiducial} simulation.\label{table:bias}}
\begin{center}
