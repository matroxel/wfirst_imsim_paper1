...
In order to translate a requirement on additive bias $c$ or multiplicative bias $m$ into requirements on lower-level quantities, we need to know how a given effect -- e.g.\ an error in the PSF model -- affects the shear measurement. 

\subsubsection{Flow-down for additive systematics}
...
\subsubsection{Flow-down for multiplicative systematics}
