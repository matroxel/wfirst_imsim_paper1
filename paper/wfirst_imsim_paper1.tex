...
We present in this paper a synthetic WFIRST weak lensing survey to full depth over 2000 sq. deg. in one filter. 
It incorporates realistic distributions of photometric properties for galaxies and stars; complex analytic galaxy models; a simulated fiducial five year observation strategy for the survey; and realistic detector effects, PSF models, and WCS solutions that match current (Cycle 7) design specifications. 
