...
We study the shape recovery in these simulations to measure empirically the relative bias due to these failure modes, in order to compare to what is anticipated from the analytical requirements flowdown that was previously developed for WFIRST.  

We present quantitative comparisons of the change in the recovered ellipticity due to these various failure modes in the wavefront model relative to the fiducial simulation. 
