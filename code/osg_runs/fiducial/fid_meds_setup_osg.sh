...
transfer_output_files   = truth/fiducial_H158_index_sorted.fits.gz
transfer_output_remaps  = "fiducial_H158_index_sorted.fits.gz = /stash/user/troxel/wfirst_sim_fiducial/truth/fiducial_H158_index_sorted.fits.gz"
