...
log            = fid_run_short_log_$(DITHER)_$(CHIP).log

Arguments = fid_osg.yaml None $(DITHER) $(CHIP) verify_output
Executable     = ../../run_osg.sh
Output         = fid_run_short_$(DITHER)_$(CHIP).log
Error          = fid_run_short_$(DITHER)_$(CHIP).log
