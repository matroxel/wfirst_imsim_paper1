...
log            = foc_run_short_log_$(DITHER)_$(CHIP).log

Arguments = foc_osg.yaml None $(DITHER) $(CHIP) verify_output
Executable     = run_osg.sh
Output         = foc_run_short_$(DITHER)_$(CHIP).log
Error          = foc_run_short_$(DITHER)_$(CHIP).log
