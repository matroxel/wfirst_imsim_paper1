...
transfer_input_files    = /home/troxel/wfirst_stack/wfirst_stack.tar.gz, \
                          ...
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/coma/dither_list.txt,\
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/coma/meds_pix_list.txt, \
...
log            = coma_run_short_log_$(DITHER)_$(CHIP).log

Arguments = coma_osg.yaml None $(DITHER) $(CHIP) verify_output
Executable     = ../run_osg.sh
Output         = coma_run_short_$(DITHER)_$(CHIP).log
Error          = coma_run_short_$(DITHER)_$(CHIP).log
