...
transfer_output_files   = truth/coma_H158_index_sorted.fits.gz
transfer_output_remaps  = "coma_H158_index_sorted.fits.gz = /stash/user/troxel/wfirst_sim_coma/truth/coma_H158_index_sorted.fits.gz"

Initialdir     = /stash/user/troxel/wfirst_sim_coma/
log            = coma_meds_setup_log.log

Arguments = coma_osg.yaml H158 meds setup
Executable     = ../run_osg.sh
Output         = coma_meds_setup.log
Error          = coma_meds_setup.log
