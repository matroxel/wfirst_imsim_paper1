...
transfer_input_files    = /home/troxel/wfirst_stack/wfirst_stack.tar.gz, \
                          ...
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/oscz4/oscz4_osg.yaml, \
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/oscz4/dither_list.txt,\
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/oscz4/meds_pix_list.txt, \
...
log            = oscz4_run_short_log_$(DITHER)_$(CHIP).log

Arguments = oscz4_osg.yaml None $(DITHER) $(CHIP) verify_output
Executable     = ../run_osg.sh
Output         = oscz4_run_short_$(DITHER)_$(CHIP).log
Error          = oscz4_run_short_$(DITHER)_$(CHIP).log
