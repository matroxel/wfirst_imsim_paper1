...
transfer_output_files   = ransmear_meds_run_osg.sh
transfer_output_remaps  = "ransmear_meds_run_osg.sh = /home/troxel/wfirst_imsim_paper1/code/ransmear_meds_run_osg.sh"
