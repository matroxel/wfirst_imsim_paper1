...
transfer_input_files    = /home/troxel/wfirst_stack/wfirst_stack.tar.gz, \
                          /home/troxel/wfirst_imsim_paper1/code/ransmear_osg.yaml, \
...
transfer_output_files   = truth/ransmear_H158_index_sorted.fits
transfer_output_remaps  = "ransmear_H158_index_sorted.fits.gz = /stash/user/troxel/wfirst_sim_ransmear/truth/ransmear_H158_index_sorted.fits.gz"

Initialdir     = /stash/user/troxel/wfirst_sim_ransmear/
log            = ransmear_meds_setup_log.log

Arguments = ransmear_osg.yaml H158 meds setup
Executable     = ../run_osg.sh
Output         = ransmear_meds_setup.log
Error          = ransmear_meds_setup.log
