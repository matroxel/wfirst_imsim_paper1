...
transfer_output_files   = anismear_meds_run_osg.sh
transfer_output_remaps  = "anismear_meds_run_osg.sh = /home/troxel/wfirst_imsim_paper1/code/anismear_meds_run_osg.sh"
