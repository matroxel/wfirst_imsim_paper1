...
transfer_input_files    = /home/troxel/wfirst_stack/wfirst_stack.tar.gz, \
                          ...
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/oscz7/oscz7_osg.yaml, \
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/oscz7/dither_list.txt,\
                          /home/troxel/wfirst_imsim_paper1/code/osg_runs/oscz7/meds_pix_list.txt, \
                          /stash/user/troxel/wfirst_sim_oscz7/run.tar
...
log            = oscz7_run_short_log_$(DITHER)_$(CHIP).log

Arguments = oscz7_osg.yaml None $(DITHER) $(CHIP) verify_output
Executable     = ../run_osg.sh
Output         = oscz7_run_short_$(DITHER)_$(CHIP).log
Error          = oscz7_run_short_$(DITHER)_$(CHIP).log
