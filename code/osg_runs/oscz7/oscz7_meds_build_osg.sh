...
transfer_output_files   = oscz7_meds_run_osg.sh
transfer_output_remaps  = "oscz7_meds_run_osg.sh = /home/troxel/wfirst_imsim_paper1/code/oscz7_meds_run_osg.sh"

Initialdir     = /stash/user/troxel/wfirst_sim_oscz7/
log            = oscz7_meds_build_log.log

Arguments = oscz7_osg.yaml H158 meds condor_build
Executable     = run_osg.sh
Output         = oscz7_meds_build.log
Error          = oscz7_meds_build.log
