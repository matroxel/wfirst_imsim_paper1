...
transfer_output_files   = truth/piston_H158_index_sorted.fits.gz
transfer_output_remaps  = "piston_H158_index_sorted.fits.gz = /stash/user/troxel/wfirst_sim_piston/truth/piston_H158_index_sorted.fits.gz"
