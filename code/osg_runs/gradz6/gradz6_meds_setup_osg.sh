...
transfer_output_files   = truth/gradz6_H158_index_sorted.fits.gz
transfer_output_remaps  = "gradz6_H158_index_sorted.fits.gz = /stash/user/troxel/wfirst_sim_gradz6/truth/gradz6_H158_index_sorted.fits.gz"

Initialdir     = /stash/user/troxel/wfirst_sim_gradz6/
log            = gradz6_meds_setup_log.log

Arguments = gradz6_osg.yaml H158 meds setup
Executable     = ../run_osg.sh
Output         = gradz6_meds_setup.log
Error          = gradz6_meds_setup.log
